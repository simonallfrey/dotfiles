...
alias fix-wire='adb shell svc usb setFunctions rndis; sleep 1; sudo nmcli device connect s25u0; sudo nmcli connection modify "6cf88492-92f6-381f-93a3-1dd198106d45" ipv4.route-metric 100; sudo nmcli connection up "6cf88492-92f6-381f-93a3-1dd198106d45"; sleep 1.5; ir'
alias g=tgpt
alias hg="tgpt<<'eof'"
